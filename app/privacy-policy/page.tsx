...
import { privacyPolicyContent } from "@/content/pages";

export const metadata: Metadata = {
  title: "Privacy Policy | Honworth",
  description: "How Honworth collects, uses, and protects your personal information.",
  openGraph: {
    title: "Privacy Policy | Honworth",
    description: "How Honworth collects, uses, and protects your personal information.",
    url: "https://honworth.in/privacy-policy",
  }
};
      ...
      <main className="flex-grow">
        ...
        <Section bgColor="white" className="py-12 md:py-20">
          <div className="max-w-3xl flex flex-col gap-10">
            {privacyPolicyContent.blocks?.map((block, idx) => (
              <div key={idx}>
